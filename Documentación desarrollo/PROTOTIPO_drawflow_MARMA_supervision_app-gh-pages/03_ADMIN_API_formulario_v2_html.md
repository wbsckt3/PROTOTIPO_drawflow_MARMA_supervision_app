...
## 8. **Gestión de Supervisores**

### 8.1. **Obtener Supervisores de la Empresa**
**GET** `/api/tenant/companies/{companyId}/supervisores`

Obtiene todos los supervisores (usuarios con rol 'editor') de una empresa específica.
...
```json
{
  ...
  "data": [
    {
      "_id": "relation_id_123",
      "googlesigninuserId": "user_id_456",
...
### 8.2. **Agregar Supervisor a la Empresa**
**POST** `/api/tenant/companies/relate-user`

Relaciona un usuario existente como supervisor (rol 'editor') de la empresa usando el endpoint existente.
...
{
  "success": true,
  "message": "Usuario relacionado exitosamente con la empresa",
  "data": {
    "_id": "new_relation_id",
    "googlesigninuserId": "user_id_789",
    "companyId": "company_id_789",
    "role": "editor",
    "fechaCreacion": "2024-01-15T10:30:00.000Z",
    "activo": true
...
### 8.3. **Eliminar Supervisor de la Empresa**
**DELETE** `/api/tenant/companies/relate-user`

Elimina la relación de un supervisor con la empresa usando el endpoint existente.
...
### 8.4. **Actualizar Estado del Supervisor**
**PUT** `/api/tenant/companies/relate-user`

Activa o desactiva un supervisor usando el endpoint existente.
